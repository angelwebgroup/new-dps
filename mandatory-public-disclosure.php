<?php include("includes/header.php"); ?>
    <section class="py-12 bg-blue-50/50">
        <div class="container mx-auto px-4">
            <div class="text-center mb-10">
                <h1 class="text-3xl font-bold text-gray-900 mb-4 uppercase tracking-wider">Mandatory Public Disclosure</h1>
            </div>
            
            <div class="max-w-5xl mx-auto">
                <h2 class="text-xl font-bold text-blue-800 mb-2 uppercase">General Information</h2>
                <div class="overflow-x-auto shadow-sm mb-10 border border-gray-200">
                    <table class="w-full text-left border-collapse">
                        <thead>
                            <tr class="bg-blue-300 text-gray-800 font-bold">
                                <th class="p-3 border border-gray-300 w-24">SL. NO.</th>
                                <th class="p-3 border border-gray-300 w-1/2">INFORMATION</th>
                        ...
                        <tbody class="text-gray-700 bg-white">
                            <tr>
                                ...
                                <td class="p-3 border border-gray-200">NAME OF THE SCHOOL</td>
                                <td class="p-3 border border-gray-200">NEW D.P.S. SCHOOL</td>
                            </tr>
                            <tr class="bg-gray-50">
                ...
                <h2 class="text-xl font-bold text-blue-800 mb-2 uppercase">Documents and Information</h2>
                <div class="overflow-x-auto shadow-sm mb-10 border border-gray-200">
                    <table class="w-full text-left border-collapse">
                        <thead>
                            <tr class="bg-blue-300 text-gray-800 font-bold">
                                <th class="p-3 border border-gray-300 w-24">SL NO.</th>
                                <th class="p-3 border border-gray-300 w-1/2">DOCUMENTS/INFORMATION</th>
                                <th class="p-3 border border-gray-300">UPLOAD DOCUMENTS</th>
                            </tr>
                        </thead>
                        <tbody class="text-gray-700 bg-white">
                            <tr>
